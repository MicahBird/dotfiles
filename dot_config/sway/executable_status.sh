...
battery_status0=$(cat /sys/class/power_supply/BAT1/status)
...
# Removed ↑ $uptime_formatted  $linux_version
echo  $name@$hostname  $wifi_name  $current_brightness% $sink_icon $current_volume% $source_icon $current_source_volume%  $current_cpu_rounded%  $current_mem_rounded% $battery_icon $battery_level_rounded% $battery_level_0% $battery_level_1%  $date_formatted
