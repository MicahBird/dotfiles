...
-- Copy over SSH: https://marceloborges.dev/posts/3/#copy-script
vim.api.nvim_create_autocmd("TextYankPost", {
  callback = function()
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'nix', 'yaml' },
